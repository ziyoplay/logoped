...
const patient=z.object({name:z.string().max(100),birth_date:emptyDate,guardian:z.string().max(100),phone:z.string().max(30),telegram:z.string().max(80),focus:z.string().max(150),notes:z.string().max(2000)}).strict();
...
const properties={patient:{name:{type:'string'},birth_date:{type:'string'},guardian:{type:'string'},phone:{type:'string'},telegram:{type:'string'},focus:{type:'string'},notes:{type:'string'}},appointment:{date:{type:'string'},time:{type:'string'},duration:{type:'integer'},title:{type:'string'},notes:{type:'string'}}};
