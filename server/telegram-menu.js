...
export async function telegramMenu(db,{chat,username,text,now}){
 ...
 return reply(card('🌿 Nutq · Sizning shaxsiy kabinetingiz',[
  ...
  'Yangi videolar shu yerga keladi.\nBotga yozilgan savollar logopedga yuborilmaydi.'
