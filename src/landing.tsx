...
export function Landing(){const root=useLandingMotion();return <div className="public-site" ref={root}>
 ...
 <header className="public-header"><PublicBrand/><nav aria-label="Sayt menyusi"><a href="#xizmatlar">Xizmatlar</a><a href="#yondashuv">Yondashuv</a><a href="#aloqa">Aloqa</a></nav><div className="public-header-actions"><ThemeSwitch/><a className="public-login" href="#kirish">Kabinetga kirish <IconArrowRight size={16}/></a></div></header>
