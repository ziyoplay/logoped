...
export function Landing(){const root=useLandingMotion();return <div className="public-site" ref={root}>
 ...
 <main className="public-main">
  <section className="public-hero"><div className="public-hero-copy"><span className="public-eyebrow"><i/> IRODA · LOGOPED VA DEFEKTOLOG</span><h1>Kichik tovushlar.<br/><em>Katta suhbatlar.</em></h1><p>Farzandingiz bilan tovushlarni aniq aytish, so‘zlash va fikrini ifodalash ustida birga ishlaymiz.</p><div className="public-cta-row"><a className="public-cta" href="https://t.me/iroda_logoped" target="_blank" rel="noreferrer">Qabul haqida yozish <IconBrandTelegram size={20}/></a><a className="parent-cabinet-link" href="#kirish">Farzandim kabineti <IconArrowRight size={18}/></a></div><span className="public-small">Savolingiz bormi? <a href="tel:+998932952290">+998 93 295 22 90</a></span></div>
  ...
  <section id="aloqa" className="public-contact"><div><span className="public-eyebrow">KELING, SUHBATLASHAMIZ</span><h2>Qabulga yozilish</h2><p>Qabul va xizmatlar haqida Iroda logopedga yozing.</p></div><div className="public-contact-links"><a href="tel:+998932952290"><IconPhone/><span><small>Telefon</small>+998 93 295 22 90</span><IconArrowRight/></a><a href="https://t.me/iroda_logoped" target="_blank" rel="noreferrer"><IconBrandTelegram/><span><small>Telegram</small>@iroda_logoped</span><IconArrowRight/></a></div></section>
 </main><footer className="public-footer"><PublicBrand/><span>Har bir qadam ahamiyatli.</span><a href="#kirish">Shaxsiy kabinet</a></footer>
 </div>;}
